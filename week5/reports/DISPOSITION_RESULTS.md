...
[Analysis and source hashes](data/handout/UltraMedia-Week5-Disposition-Analysis.json) · [all 240 case rows](data/handout/UltraMedia-Week5-Disposition-Cases.csv) · [reproduction script](../scripts/derive_disposition_metrics.py) · [original local comparison](LOCAL_COMPARISON_RESULTS.md)
